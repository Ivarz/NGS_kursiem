...
\newcommand{\snpEffGC}[2]{\texttt{java -jar -Xmx3g \textasciitilde/programs/snpEff/snpEff.jar~\textbackslash \\
  \indent ann~\textbackslash \\
  \indent -c \textasciitilde/programs/snpEff/snpEff.config~\textbackslash \\
  \indent GRCh38.76~\textbackslash \\
  \indent #1~\textbackslash \\
...
\newcommand{\SnpSiftAnnotate}[2]{\texttt{java -jar \textasciitilde/programs/snpEff/SnpSift.jar~\textbackslash \\
  \indent annotate~\textbackslash \\
  \indent \textasciitilde/data/day1/snpEffData/00-All.vcf~\textbackslash \\
